...
export function DateSelect({ selectDate, onClick }: DateSelectProps) {
  ...
  return (
    <StyledDateSelect>
      <StyledDateHeader>
        <Button onClick={handlePrveClick} icon={faAngleLeft} />
        ...
        <Button onClick={handleNextClick} icon={faAngleRight} />
      </StyledDateHeader>
      <StyledDateContent>
